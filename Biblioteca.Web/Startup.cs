...
namespace Biblioteca.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<BibliotecaDbContext>(options =>
                options.UseSqlServer(
                     ...
                     {
                         options.MigrationsAssembly("Biblioteca.Web");
                     }));
            ...
            services.AddIdentityServer()
                .AddApiAuthorization<ApplicationUser, BibliotecaDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            //        .MapRoute(name: "api", template: c);
            //});

            loggerFactory.AddFile("Logs/Biblioteca-{Date}.txt");
